...
var (
	...
	ErrPrescriptionAlreadyExists  = errors.New("prescription already exists for this item")
	ErrMedicineNotFound           = errors.New("medicine not found")
	ErrInvalidSigningMethod       = errors.New("invalid signing method")
	ErrRAGServiceError            = errors.New("RAG service error")
	ErrOnlyPendingCanBeRedeemed   = errors.New("hanya e-resep berstatus Pending yang dapat ditebus")
	ErrMedicalRecordRequired      = errors.New("sesi konsultasi tidak dapat diselesaikan sebelum dokter mengisi rekam medis pasien")
	ErrCancellationReasonRequired = errors.New("alasan pembatalan janji temu wajib diisi minimal 5 karakter")
)
