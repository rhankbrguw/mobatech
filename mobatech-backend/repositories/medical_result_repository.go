...
func (r *medicalResultRepository) applyFilters(ctx context.Context, query *gorm.DB, search, filter, role string, userID uint) *gorm.DB {
...
func (r *medicalResultRepository) FindAll(ctx context.Context, search string, filter string, userID uint, role string, limit int, offset int) ([]models.MedicalResult, int64, error) {
	...
	query = r.applyFilters(ctx, query, search, filter, role, userID)
