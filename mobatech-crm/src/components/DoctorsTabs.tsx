    ...
    <div className="flex flex-wrap gap-2 p-1 bg-overlay-dark dark:bg-overlay-light rounded-xl w-full sm:w-max">
      <button
        ...
        className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors w-full sm:w-auto ${
          activeTab === "doctors" ? "bg-surface-primary dark:bg-foreground/50 shadow text-primary" : "text-foreground/60 hover:text-foreground"
        }`}
      >
      ...
      <button
        ...
        className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors w-full sm:w-auto ${
          activeTab === "schedules" ? "bg-surface-primary dark:bg-foreground/50 shadow text-primary" : "text-foreground/60 hover:text-foreground"
        }`}
      >
