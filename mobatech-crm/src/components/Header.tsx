...
export function Header() {
  ...
  return (
    <header className="h-14 sm:h-16 border-b border-glass-border bg-surface-primary/70 dark:bg-[#091a13]/85 backdrop-blur-xl flex items-center justify-between px-3 sm:px-4 md:px-8 fixed top-0 right-0 left-0 lg:left-64 z-20 transition-all duration-300 shadow-sm">
