  ...
  return (
    <SideDrawer isOpen={isOpen} onClose={onClose} title={APP_STRINGS.details.promoTitle}>
      <div className="space-y-4">
        ...
        >
          <h3 className="text-xl font-bold text-surface-primary drop-shadow-md">{promo.title}</h3>
          <p className="text-surface-primary/90 text-sm">{promo.subtitle}</p>
        </div>
