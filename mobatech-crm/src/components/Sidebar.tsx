...
export function Sidebar() {
  ...
  const navItems = [
    { name: APP_STRINGS.sidebar.dashboard, path: "/dashboard", icon: <LayoutDashboard size={20} /> },
    { name: "Daftar Pasien", path: "/dashboard/patients", icon: <Users size={20} /> },
    { name: APP_STRINGS.sidebar.polyclinics, path: "/dashboard/polyclinics", icon: <Building2 size={20} /> },
    { name: "Cabang RS", path: "/dashboard/branches", icon: <Building2 size={20} /> },
    { name: APP_STRINGS.sidebar.doctors, path: "/dashboard/doctors", icon: <Stethoscope size={20} /> },
    { name: "Antrean", path: "/dashboard/appointments", icon: <CalendarDays size={20} /> },
    { name: "Darurat", path: "/dashboard/emergencies", icon: <Siren size={20} /> },
    { name: "Apotek", path: "/dashboard/pharmacy", icon: <Pill size={20} /> },
    { name: "Hasil Medis", path: "/dashboard/medical-results", icon: <FileText size={20} /> },
    { name: "Pengingat", path: "/dashboard/reminders", icon: <Bell size={20} /> },
    { name: APP_STRINGS.sidebar.aiAudit, path: "/dashboard/ai-audit", icon: <Bot size={20} /> },
  ];
