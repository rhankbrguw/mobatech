    ...
    <SideDrawer isOpen={isOpen} onClose={onClose} title={APP_STRINGS.details.userTitle}>
      <div className="space-y-4">
        <div className="flex items-center gap-4">
          <Image unoptimized={true} width={100} height={100} src={user.image_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.full_name)}&background=1e5e44&color=fff`} alt={user.full_name} className="w-16 h-16 rounded-full border border-glass-border object-cover" />
          <div>
