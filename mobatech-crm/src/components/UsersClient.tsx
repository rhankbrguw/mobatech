  ...
  return (
    <div className="space-y-6 animate-slide-in">
      <PageHeader
        ...
        action={
          <Button onClick={() => { u.setEditingUser(null); u.setShowModal(true); }} icon={<Plus size={16} className="sm:w-[18px] sm:h-[18px]" />}>
            <span className="sm:hidden">{APP_STRINGS.common.add}</span>
            <span className="hidden sm:inline">{APP_STRINGS.users.addBtn}</span>
          </Button>
        }
      />
