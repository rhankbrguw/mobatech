      ...
      {medicine && (
        <div className="space-y-4">
          <div className="flex items-center gap-4 border-b border-glass-border pb-4">
            {medicine.image_url ? (
              <Image unoptimized={true} width={100} height={100} src={medicine.image_url || "/globe.svg"} alt={medicine.name} className="w-20 h-20 object-cover rounded-xl border border-glass-border shadow-sm" />
            ) : (
