...
const TD_CLASS = "py-3 px-3 sm:px-4 align-middle whitespace-nowrap border-b border-glass-border/30 text-xs sm:text-sm";
      ...
      <td className={TD_CLASS}>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-overlay-dark dark:bg-overlay-light border border-glass-border/50 flex items-center justify-center overflow-hidden shrink-0">
            {medicine.image_url ? (
              <Image unoptimized={true} width={100} height={100} src={medicine.image_url || "/globe.svg"} alt={medicine.name} className="w-full h-full object-cover" />
            ) : (
