...
export function PharmacyPrescriptions({ initialPrescriptions }: { initialPrescriptions?: Prescription[] }) {
  ...
  if (!["admin", "pharmacist"].includes(userRole)) return <ForbiddenView />;
  ...
  return (
    <div className="space-y-6 animate-slide-in">
      <PageHeader title="Daftar E-Resep" description="Pantau dan proses permintaan tebus obat dari pasien secara real-time." />
      ...
      <div className="flex justify-end mb-4 gap-2">
        ...
        />
        <SearchFilterBar value={searchQuery} onChange={setSearchQuery} placeholder="Cari ID/Dokter..." />
      </div>
