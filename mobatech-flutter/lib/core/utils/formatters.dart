...
class Formatters {
  ...
  static String getDayOfWeekID(DateTime d) =>
      CoreFormatters.daysOfWeek[d.toLocal().weekday - 1];

  static String getMonthID(DateTime d) =>
      CoreFormatters.months[d.toLocal().month - 1];
  ...
  static String _formatCleanPhone(String cleanPhone, String prefix) {
    final String localPart = cleanPhone.substring(3);
    if (localPart.length <= 3) {
      return localPart.isEmpty ? cleanPhone : '$prefix $localPart';
    }
    final String p1 = localPart.substring(0, 3);
    final String remainder = localPart.substring(3);
  ...
  static String formatPhoneNumber(String phone) {
    final String cleanPhone = _cleanPhone(phone);
