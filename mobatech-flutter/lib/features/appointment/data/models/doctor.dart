...
Object? _readPolyclinicName(Map<dynamic, dynamic> json, String key) {
  if (json['polyclinic_name'] != null && json['polyclinic_name'].toString().isNotEmpty) {
    return json['polyclinic_name'];
  }
  final poly = json['polyclinic'];
  if (poly is Map && poly['name'] != null) {
    return poly['name'];
  }
  return null;
}
...
abstract class Doctor with _$Doctor {
  ...
  const factory Doctor({
    ...
    @JsonKey(name: 'polyclinic_name', readValue: _readPolyclinicName) String? polyclinicName,
    @Default('') String name,
  ...
  static Doctor fromBackendJson(Map<String, dynamic> json) {
    ...
    final polyName = json['polyclinic_name'] ?? (poly is Map<String, dynamic> ? poly['name'] : null);
