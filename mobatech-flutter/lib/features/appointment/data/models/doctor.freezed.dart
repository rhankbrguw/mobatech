...
@JsonKey(name: 'ID') int get id;@JsonKey(name: 'user_id') int? get userId;@JsonKey(name: 'polyclinic_id') int? get polyclinicId;@JsonKey(name: 'polyclinic_name', readValue: _readPolyclinicName) String? get polyclinicName; String get name; String get specialization;@JsonKey(name: 'contact_info') String get contactInfo; String get description;@JsonKey(name: 'image_url') String get imageUrl;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'is_available_today') bool get isAvailableToday;
...
@override@JsonKey(name: 'polyclinic_name', readValue: _readPolyclinicName) final  String? polyclinicName;
