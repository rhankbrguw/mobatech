...
class _EditMedicalDataModalContentState
  ...
  void _onSuccess() {
    ...
    CustomSnackbar.showSuccess(context, ProfileStrings.extDatafisikberhasildiperbarui);
  }

  void _onError(dynamic error) => CustomSnackbar.showError(context, ErrorHandler.getMessage(error));
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: EditMedicalDataFormFields(
            ...
            onBloodTypeChanged: (val) => val != null ? setState(() => _selectedBloodType = val) : null,
